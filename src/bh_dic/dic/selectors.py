...
DEFAULT_SELECTORS = SelectorRegistry(
    {
        ...
        "auth.teamsystem_password_submit": (css("#submitBtn"),),
        "employees.rows": (
        ...
        "balance.year_selector": (css("dic-year-selector"),),
        "balance.year_current": (css("dic-year-selector .year"),),
        "balance.year_previous": (css("dic-year-selector button[iconleft='chevron-left']"),),
        "balance.year_next": (css("dic-year-selector button[iconleft='chevron-right']"),),
        ...
        "payrolls.rows": (
            css("dic-employee-payroll-list table tbody tr"),
            test_id("payroll-row"),
            css("table tbody tr"),
        ),
        "payrolls.year": (label("Anno"), test_id("payroll-year")),
        "payrolls.year_selector": (css("dic-year-selector"),),
        "payrolls.year_current": (css("dic-year-selector .year"),),
        "payrolls.year_previous": (css("dic-year-selector button[iconleft='chevron-left']"),),
        "payrolls.year_next": (css("dic-year-selector button[iconleft='chevron-right']"),),
